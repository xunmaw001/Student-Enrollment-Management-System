<template>
    <div style="backgroundImage: url('/xueshengxueji/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">学生学籍管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="教务人员姓名" class="input" v-if="tableName=='jiaowurenyuan'">
                            <el-input v-model="ruleForm.jiaowurenyuanName" autocomplete="off" placeholder="教务人员姓名"  />
                        </el-form-item>
                        <el-form-item label="身份证号" class="input" v-if="tableName=='jiaowurenyuan'">
                            <el-input v-model="ruleForm.jiaowurenyuanIdNumber" autocomplete="off" placeholder="身份证号"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.jiaowurenyuanName)&& 'jiaowurenyuan'==this.tableName){
                                this.$message.error('教务人员姓名不能为空');
                                return
                            }
                            if((!this.ruleForm.jiaowurenyuanIdNumber)&& 'jiaowurenyuan'==this.tableName){
