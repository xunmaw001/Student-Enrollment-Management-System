               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家庭地址" prop="yonghuAddress">
                       <el-input v-model="ruleForm.yonghuAddress"
                                 placeholder="家庭地址" clearable  :readonly="ro.yonghuAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学籍状态" prop="xuejiTypes">
                        <el-select v-model="ruleForm.xuejiTypes" :disabled="ro.xuejiTypes" placeholder="请选择学籍状态">
                            <el-option
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xuejiTypes: [
                              { required: true, message: '学籍状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
