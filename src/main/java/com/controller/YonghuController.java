                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            yonghuEntity.setYonghuAddress(data.get(3));                    //家庭地址 要改的
                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(4)));   //性别 要改的
                            yonghuEntity.setXueyuanTypes(Integer.valueOf(data.get(5)));   //学院 要改的
                            yonghuEntity.setBanjiTypes(Integer.valueOf(data.get(6)));   //班级 要改的
                            yonghuEntity.setXuejiTypes(Integer.valueOf(data.get(7)));   //学籍状态 要改的
