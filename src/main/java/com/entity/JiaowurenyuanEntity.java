...
public class JiaowurenyuanEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Jiaowurenyuan{" +
            "id=" + id +
            ", jiaowurenyuanUuidNumber=" + jiaowurenyuanUuidNumber +
            ", username=" + username +
            ", password=" + password +
            ", jiaowurenyuanName=" + jiaowurenyuanName +
            ", jiaowurenyuanIdNumber=" + jiaowurenyuanIdNumber +
            ", sexTypes=" + sexTypes +
            ", jiaowurenyuanDelete=" + jiaowurenyuanDelete +
